...
Command: npx gltfjsx@6.2.16 checkers-ui/public/models/MainAvatar.glb -t 
*/
...
export function MainAvatar(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/models/MainAvatar.glb') as GLTFResult
  return (
...
useGLTF.preload('/models/MainAvatar.glb')
